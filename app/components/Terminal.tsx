...
.lectr-cp-monorules{position:absolute;top:10px;left:12px;right:12px;height:5px;background:linear-gradient(to bottom,var(--color-fg) 0,var(--color-fg) 2px,transparent 2px,transparent 4px,rgba(255,255,255,0.28) 4px,rgba(255,255,255,0.28) 5px)}
...
@media (min-width:900px){
  ...
  .ray-board-belowrow .lectr-cp .ray-plate-cap{margin-top:12px;border-top:1px solid var(--hairline);padding-top:9px;font-size:11px;color:var(--color-text-muted)}
  ...
  .ray-board-belowrow .lectr-cp .lectr-cp-fill{flex:1;border-bottom:1px dotted rgba(255,255,255,0.2);transform:translateY(-3px)}
