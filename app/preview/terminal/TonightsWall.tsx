...
export default function TonightsWall({
  ...
  // the open's clock — plates rise from T+1200 when the greeting is writing
  const base = useMemo(() => {
    const el = play ? openElapsed() : null;
    return el != null && el < 2300 ? Math.max(0, 1200 - el) : 0;
    // decided once at arrival
